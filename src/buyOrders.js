...
async function main() {
  await executeBuyOrdersWithList([coinListA, coinListB], 100).then(() => console.log('Orders for A and B executed.'));
  await executeBuyOrdersWithList([coinListC, coinListD], 50).then(() => console.log('Orders for C and D executed.'));
  await executeBuyOrdersWithList([coinListE, coinListF], 50).then(() => console.log('Orders for E and F executed.'));
